Table of Contents
 * [ad-ldap-tool.sh](#ad-ldap-toolsh---search-microsoft-active-directory-using-ldapsearch)
 * [apt-update-security-packages.sh](#apt-update-security-packagessh---update-apt-packages-for-security-updates)
 ...
 * [aws-cli-cache-auth-keys.sh](#aws-cli-cache-auth-keyssh---extract-the-auth-keys-from-a-cached-aws-cli-authentication-json-file)
 * [aws-create-update-secret](#aws-create-update-secret---create-or-update-an-aws-secrets-manager-secret)
 * [aws-ec2-describe-sec-group-rules.sh](#aws-ec2-describe-sec-group-rulessh---print-a-tsv-of-aws-ec2-security-group-rules)
 * [aws-ec2-get-instance-id.sh](#aws-ec2-get-instance-idsh---get-the-instance-id-of-running-aws-ec2-instances)
 * [aws-ec2-get-ip.sh](#aws-ec2-get-ipsh---get-the-ips-of-running-aws-ec2-instances)
 * [aws-ec2-get-network-interface-public-ips.sh](#aws-ec2-get-network-interface-public-ipssh---get-the-public-ip-of-aws-ec2-network-interfaces)
 * [aws-ec2-get-running-instances.sh](#aws-ec2-get-running-instancessh---get-the-instance-id-key-name-group-id-and-public-ip-of-running-aws-ec2-instances)
 * [aws-ec2-get-security-groups.sh](#aws-ec2-get-security-groupssh---get-aws-ec2-security-groups)
 * [aws-ec2-get-sg-ids.sh](#aws-ec2-get-sg-idssh---get-aws-ec2-instance-security-group-ids)
 ...
 * [aws-ecs-utils.sh](#aws-ecs-utilssh---wrapper-for-simpler-operations-on-aws-ecs)
 * [aws-rds-get-ip.sh](#aws-rds-get-ipsh---get-aws-rds-ip-addresses-for-running-instances)
 * [aws-s3-get-buckets.sh](#aws-s3-get-bucketssh---get-aws-s3-bucket-names)
 ...
 * [bitbucket-list-all-repos.py](#bitbucket-list-all-repospy---return-a-csv-file-of-bitbucket-repositories)
 * [bitbucket-list-all-repos.sh](#bitbucket-list-all-repossh---return-a-json-document-of-available-bitbucket-repositories-for-a-specific-bitbucketteam)
 * [bitbucket-list-repo-commits.py](#bitbucket-list-repo-commitspy---return-a-csv-of-bitbucket-repositories)
 * [bitbucket-manage.py](#bitbucket-managepy---a-management-cli-tool-for-bitbucket-repositories)
 * [bluetooth-reset.sh](#bluetooth-resetsh---linux-bluetooth-needs-a-kick-in-the-pants-every-time-i-connect-my-headset-)
 * [bluez-set-a2dp.sh](#bluez-set-a2dpsh---try-to-force-enable-a2dp-mode-for-bluetooth-devices)
 * [butler-jenkins-export-import.sh](#butler-jenkins-export-importsh---use-butlet-to-export-and-import-jobs-and-credentials-for-jenkins-servers)
 * [cgrep](#cgrep---wrapper-for-grep-with-color-mode-forced-on)
 * [circleci-manage.py](#circleci-managepy---a-management-cli-for-circleci-operations-the-official-cli-doesnt-support)
 * [cpufreq-set-all](#cpufreq-set-all---set-cpu-frequency)
 * [csv_row_template_output.py](#csvrowtemplateoutputpy---generate-a-set-of-files-based-on-a-python-template-and-csv-file)
 ...
 * [date-seconds-portable.sh](#date-seconds-portablesh---a-portable-implementation-of-date-output-given-seconds)
 * [docker-detach-sshd.sh](#docker-detach-sshdsh---run-a-detached-docker-container-with-an-entrypoint-to-run-an-sshd-daemon)
 * [docker-login-list-registries](#docker-login-list-registries---list-docker-cli-configs-registries)
 * [docker-registry-list-repositories](#docker-registry-list-repositories---list-docker-cli-configs-repositories)
 ...
 * [docker-run-op](#docker-run-op---run-1passwords-op-cli-tool-with-docker)
 * [docker-sshd-entrypoint.sh](#docker-sshd-entrypointsh---install-and-run-sshd-in-a-docker-container)
 * [download-aws-secret-env.sh](#download-aws-secret-envsh-v02---download-aws-secrets-manager-secrets-store-in-a-file-and-execute-a-program)
 * [download-tls-cert.sh](#download-tls-certsh---download-tls-certificate-from-a-hostport)
 * [envsubst.sh](#envsubstsh---posix-compatible-version-of-envsubst)
 ...
 * [gcp-list-service-account-keys.sh](#gcp-list-service-account-keyssh---list-gcp-service-account-keys)
 * [git-askpass-netrc.sh](#git-askpass-netrcsh---use-netrc-with-git-askpass)
 * [git-clean-workdir.sh](#git-clean-workdirsh---clean-up-temporary-files-in-a-git-working-directory)
 * [git-clean.sh](#git-cleansh---interactively-remove-unchecked-in-git-working-directory-files)
 * [git-cleanup-local-stale.sh](#git-cleanup-local-stalesh---remove-any-stale-local-and-remote-git-branches-from-local-repository)
 * [git-commit-file.sh](#git-commit-filesh---automation-for-committing-files-to-git)
 * [git-find-ignored.sh](#git-find-ignoredsh---show-all-the-files-in-the-current-git-repo-that-are-being-ignored-by-gitignore)
 * [git-fix-commit-author.sh](#git-fix-commit-authorsh---rewrite-git-history-to-correct-the-wrong-commit-author-details)
 * [git-grep-entire-repo-history.sh](#git-grep-entire-repo-historysh---grep-the-entire-history-of-a-git-repository)
 * [git-http-check-origin-exists.sh](#git-http-check-origin-existssh---in-case-you-want-to-use-curl-to-see-if-an-https-git-repo-actually-exists-or-not)
 * [git-lfs-compare.sh](#git-lfs-comparesh---compare-the-files-in-a-git-repository-with-the-files-in-git-lfs)
 * [git-list-branch-by-date.sh](#git-list-branch-by-datesh---list-git-branches-by-date-of-last-commit)
 * [git-list-repo-files.sh](#git-list-repo-filessh---list-all-files-checked-into-a-git-repository)
 * [git-list-untracked-ignored.sh](#git-list-untracked-ignoredsh---list-untracked-and-ignored-files-in-a-git-repository)
 * [git-list-untracked.sh](#git-list-untrackedsh---list-untracked-files-in-a-git-repository)
 * [git-permanently-remove-file-from-repo.sh](#git-permanently-remove-file-from-reposh---rewrite-history-to-permanently-remove-a-file-from-a-git-repository)
 * [git-push-force-all.sh](#git-push-force-allsh---force-push-a-git-repository-with-tags)
 * [git-show-commit-authors.sh](#git-show-commit-authorssh---list-all-of-the-commit-authors-in-a-git-repository)
 * [git-show-mainline-branch.sh](#git-show-mainline-branchsh---attempt-to-show-mainline-branch-of-a-git-repository)
 * [git-squash-current-branch.sh](#git-squash-current-branchsh---squash-your-current-branchs-commits-based-on-mainbranch)
 * [github-get-pr](#github-get-pr---get-a-pull-request-branch-from-github)
 * [github-get-restapi.sh](#github-get-restapish---curl-the-github-api)
 * [github-get-team-members.sh](#github-get-team-memberssh---use-get-github-restapish-to-get-github-team-members-list)
 * [github-get-team.sh](#github-get-teamsh---use-get-github-restapish-to-get-github-teams-list)
 ...
 * [jenkins-groovy-remote.sh](#jenkins-groovy-remotesh---run-a-groovy-file-on-a-jenkins-server-via-the-api)
 * [jenkins-run-groovy-remote.sh](#jenkins-run-groovy-remotesh---takes-a-groovy-file-replaces-some-variables-and-executes-it-on-a-remote-jenkins-instance)
 * [jenkins-run-job-with-parameter-defaults.py](#jenkins-run-job-with-parameter-defaultspy---run-a-jenkins-job-with-parameters)
 * [jenkins-trigger-paramaterized-build.py](#jenkins-trigger-paramaterized-buildpy---run-a-jenkins-parameterized-build)
 * [jenkinsctl](#jenkinsctl---a-command-line-wrapper-around-building-and-running-a-jenkins-instance)
 * [k8s-copy-secret-across-namespace.sh](#k8s-copy-secret-across-namespacesh---copy-a-kubernetes-secret-into-a-new-namespace)
 ...
 * [k8s-diff-secret-by-ns.sh](#k8s-diff-secret-by-nssh---diff-k8s-secrets-between-two-namespaces)
 * [k8s-diff-secret.sh](#k8s-diff-secretsh---diff-k8s-secrets-this-is-broken)
 ...
 * [k8s-get-pods-running.sh](#k8s-get-pods-runningsh---get-running-k8s-pods)
 * [k8s-get-secret-values.sh](#k8s-get-secret-valuessh---output-kubernetes-secret-keys-and-values-in-plaintext)
 * [k8s-get-secrets-opaque.sh](#k8s-get-secrets-opaquesh---get-any-opaque-type-k8s-secrets)
 * [k8s-run-shell.sh](#k8s-run-shellsh---start-a-k8s-pod-and-open-an-interactive-shell-then-destroy-it-on-exit)
 * [k8s-show-error.sh](#k8s-show-errorsh---show-k8s-errors-for-certificate-manager)
 * [kd](#kd---a-terminal-user-interface-wrapper-for-kubernetes-commands)
 * [load-vim-plugins.sh](#load-vim-pluginssh---load-vim-plugins)
 * [make-readme.sh](#make-readmesh---generates-a-readmemd-based-on-the-comment-descriptions-after-a-shebang-in-a-script)
 * [move-files-to-folders-by-ext.sh](#move-files-to-folders-by-extsh---move-all-the-files-in-a-directory-into-folders-named-by-extension)
 * [docker-delete-registry-image.py](#note-i-dont-know-who-wrote-this-it-was-probably-downloaded-from-the-internet)
 * [notes.sh](#notessh---shell-script-to-manage-hierarchy-of-note-files)
 * [python-stdin-to-json.py](#python-stdin-to-jsonpy---dump-standard-input-stream-as-a-json-formatted-output)
 * [random-dict-password.sh](#random-dict-passwordsh---generate-a-random-password-from-dictionary-words)
 * [random-password.sh](#random-passwordsh---generate-a-random-password)
 * [remote-gpg](#remote-gpg---run-gpg-operations-on-a-remote-host)
 * [reset-ntp.sh](#reset-ntpsh---update-the-time-on-a-box-using-ntp)
 * [ssh](#ssh---ssh-wrapper-to-override-term-setting-so-that-ssh-will-send-the-one-we-want-remotely)
 * [ssh-config-hosts.sh](#ssh-config-hostssh---recursively-find-any-host-host-lines-in-local-ssh-configs)
 * [ssh-mass-run-script.sh](#ssh-mass-run-scriptsh---send-a-script-to-a-lot-of-hosts-and-then-execute-it-on-them)
 * [terraform-find-missing-vars.pl](#terraform-find-missing-varspl---find-missing-variable-definitions-in-a-terraform-module)
 * [ubuntu-18.04-setup-dnsmasq.sh](#ubuntu-1804-setup-dnsmasqsh---set-up-dnsmasq-on-ubuntu-1804)
 * [ubuntu-list-pkgs-by-date.sh](#ubuntu-list-pkgs-by-datesh---self-explanatory)
 * [uniqunsort](#uniqunsort---remove-duplicated-lines-from-stdin-print-to-stdout)
 * [urlencode.sh](#urlencodesh---print-a-string-url-encoded)
 * [virtualenv](#virtualenv---run-virtualenv-installing-it-if-needed)
 * [wget-mirror.sh](#wget-mirrorsh---use-wget-to-create-a-mirror-of-a-website)
 * [wordpress-salt-envs.sh](#wordpress-salt-envssh---download-the-default-salts-for-wordpress)
